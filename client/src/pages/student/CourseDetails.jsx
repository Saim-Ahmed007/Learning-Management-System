    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p
            className="pt-3 md:text-base text-sm"
          ...
          <p className="pt-3">
            CourseBy <span className="text-blue-500 underline">Saim Ahmed</span>
          </p>
          <div className="pt-8">
          ...
          <h1 className="text-xl font-semibold pt-5">Course Description</h1>
          <p
            className="pt-3 md:text-base text-sm py-20"
            dangerouslySetInnerHTML={{
              __html: courseData?.courseDescription.slice(0, 200),
            }}
          ></p>
        ...
        {/* right column */}
        <div className="shadow-md rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] md:mb-20">
          {playerData ? (
            <Youtube
          ...
          <div className="p-5">
            ...
            <button className="bg-blue-500 text-white py-3 rounded w-full mt-10">
            ...
            <div className="pt-5">
              ...
              <ol className="text-gray-500 space-y-2 pt-3">
